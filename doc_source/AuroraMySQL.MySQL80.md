...
+  Currently, choosing Aurora MySQL version 3 for an RDS proxy might produce a proxy that's not associated with your cluster\. This is a short\-term temporary limitation\. 
...
```   ](#AuroraMySQL.mysql80-upgrade-procedure)\. 
...
**Note**  
 ...
 After you finish the upgrade itself, you can follow the post\-upgrade procedures in [Post\-upgrade cleanup for Aurora MySQL version 3](#AuroraMySQL.mysql80-post-upgrade)\. test your application's functionality and performance\. 
