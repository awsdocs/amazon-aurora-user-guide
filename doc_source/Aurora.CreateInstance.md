...
| --- | --- | 
|   **Availability zone**   |  Determine if you want to specify a particular Availability Zone\. For more information about Availability Zones, see [Choosing the Regions and Availability Zones](Concepts.RegionsAndAvailabilityZones.md)\.  | 
...
|   **Publicly accessible**   |  Choose **Yes** to give the DB cluster a public IP address; otherwise, choose **No**\. The instances in your DB cluster can be a mix of both public and private DB instances\. For more information about hiding instances from public access, see [Hiding a DB Instance in a VPC from the Internet](USER_VPC.WorkingWithRDSInstanceinaVPC.md#USER_VPC.Hiding)\.  | 
