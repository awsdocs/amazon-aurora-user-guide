...
|   **Enable Performance Insights**   |  Choose `Enable Performance Insights` to enable Amazon RDS Performance Insights\. For more information, see [Using Performance Insights on Amazon Aurora](USER_PerfInsights.md)\.  | 
...
|   **Option group**   |  Aurora has a default option group\.  | 
|  **Performance Insights**  |  Doesn't apply to MySQL 5\.6\. Choose **Enable Performance Insights** if you want to use Amazon RDS Performance Insights to monitor your Amazon Aurora DB cluster load\. For more information about Performance Insights, see [Using Performance Insights on Amazon Aurora](USER_PerfInsights.md)\.   | 
