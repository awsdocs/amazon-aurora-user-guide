# Connecting to Your DB Cluster Using IAM Authentication<a name="UsingWithRDS.IAMDBAuth.Connecting"></a>
...
After you have a signed IAM authentication token, you can connect to an Aurora DB cluster\. Following, you can find out how to do this using either a command line tool or an AWS SDK, such as the AWS SDK for Java or AWS SDK for Python \(Boto 3\)\.
