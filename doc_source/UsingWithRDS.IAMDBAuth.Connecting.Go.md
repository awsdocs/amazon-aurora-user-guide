...
+ [Connecting to a DB cluster](#UsingWithRDS.IAMDBAuth.Connecting.GoV2.AuthToken.Connect)
...
### Connecting to a DB cluster<a name="UsingWithRDS.IAMDBAuth.Connecting.GoV2.AuthToken.Connect"></a>
...
+ [Connecting to a DB cluster](#UsingWithRDS.IAMDBAuth.Connecting.GoV1.AuthToken.Connect)
...
### Connecting to a DB cluster<a name="UsingWithRDS.IAMDBAuth.Connecting.GoV1.AuthToken.Connect"></a>
