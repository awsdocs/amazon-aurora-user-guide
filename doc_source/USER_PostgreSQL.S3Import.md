...
You can import data from Amazon S3 into a table belonging to an Aurora PostgreSQL DB cluster\. To do this, you use the `aws_s3` PostgreSQL extension that Aurora PostgreSQL provides\. Your database must be running PostgreSQL version 10\.7 or higher to import from Amazon S3 into Aurora PostgreSQL\. You can import into a provisioned DB instance only\. That is, these steps aren't supported for Aurora Serverless v1\. 
