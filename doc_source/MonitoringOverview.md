...
| FreeableMemory |  The amount of available random access memory\.   For Aurora, this metric reports the value of the `MemAvailable` field of /proc/meminfo\.  Units: Bytes  | 
...
**Note**  
Before you enable log data publishing, you must have a service\-linked role in AWS Identity and Access Management \(IAM\)\. For more information about service\-linked roles, see [Using Service\-Linked Roles for Amazon Aurora](UsingWithRDS.IAM.ServiceLinkedRoles.md)\.
...
![\[RDS metrics viewing options\]](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/metrics0.png)
**Tip**  
