...
+ For a list of the common wait events for Aurora MySQL, see [Aurora MySQL wait events](AuroraMySQL.Reference.Waitevents.md)\. To learn how to tune using these wait events, see [Tuning Aurora MySQL with wait events and thread states](AuroraMySQL.Managing.Tuning.md)\.
