# Tutorial: Create a VPC for use with a DB cluster \(dual\-stack mode\)<a name="CHAP_Tutorials.CreateVPCDualStack"></a>
...
For more information about IP addressing, see [Amazon Aurora IP addressing](USER_VPC.WorkingWithRDSInstanceinaVPC.md#USER_VPC.IP_addressing)\.
...
1. Add inbound rules to the security group:
   ...
   1. Set the following values for your new inbound rule to allow MySQL traffic on port 3306 from your Amazon EC2 instance\. If you do, you can connect from your EC2 instance to your DB cluster\. Doing this means that you can store and retrieve data from your EC2 instance to your database\.
      + **Type:** **MySQL/Aurora**
...
## Create a DB cluster in dual\-stack mode<a name="CHAP_Tutorials.CreateVPCDualStack.CreateDBInstance"></a>
...
To connect to your DB cluster, follow the instructions in [Connecting to an Amazon Aurora DB cluster](Aurora.Connecting.md)\.
