# MySQL bugs fixed by Aurora MySQL database engine updates<a name="AuroraMySQL.Updates.MySQLBugs"></a>
...
| [Aurora MySQL database engine updates 2021\-11\-24 \(version 2\.07\.7\)](AuroraMySQL.Updates.2077.md) |  2\.07\.7  |   INSERTING 64K SIZE RECORDS TAKE TOO MUCH TIME\. \(Bug\#23031146\)   | 
| [Aurora MySQL database engine updates 2021\-09\-02 \(version 2\.07\.6\)](AuroraMySQL.Updates.2076.md) |  2\.07\.6  |  [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Updates.MySQLBugs.html)  | 
| [Aurora MySQL database engine updates 2021\-03\-04 \(version 2\.07\.4\)](AuroraMySQL.Updates.2074.md) |  2\.07\.4  |  [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Updates.MySQLBugs.html)  | 
| [Aurora MySQL database engine updates 2020\-11\-10 \(version 2\.07\.3\)](AuroraMySQL.Updates.2073.md) |  2\.07\.3  |  [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Updates.MySQLBugs.html)  | 
...
| [Aurora MySQL database engine updates 2018\-09\-21](AuroraMySQL.Updates.2024.md) |  2\.02\.4  |  [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Updates.MySQLBugs.html)  | 
| [Aurora MySQL database engine updates 2018\-05\-03](AuroraMySQL.Updates.202.md) |  2\.02\.0  |  Left join returns incorrect results on the outer side \(Bug \#22833364\)  | 
...
| Database engine update | Version | MySQL bugs fixed | 
| --- | --- | --- | 
| [Aurora MySQL database engine updates 2021\-03\-18 \(version 1\.23\.2\)](AuroraMySQL.Updates.1232.md) | 1\.23\.2 |  [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Updates.MySQLBugs.html)  | 
...
| [Aurora MySQL database engine updates 2020\-11\-09 \(version 1\.22\.3\)](AuroraMySQL.Updates.1223.md) | 1\.22\.3 |  [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Updates.MySQLBugs.html)  | 
...
| [Aurora MySQL database engine updates 2018\-03\-13](AuroraMySQL.Updates.117.md) | 1\.17\.0 |  [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Updates.MySQLBugs.html)  | 
...
| [Aurora MySQL database engine updates 2017\-10\-24](AuroraMySQL.Updates.20171024.md) | 1\.15\.0 |  [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Updates.MySQLBugs.html)  | 
...
| [Aurora MySQL database engine updates: 2017\-08\-07](AuroraMySQL.Updates.20170807.md) | 1\.14\.0 |  A full\-text search combined with derived tables \(subqueries in the `FROM` clause\) caused a server exit\. Now, if a full\-text operation depends on a derived table, the server produces an error indicating that a full\-text search cannot be done on a materialized table\. \(Bug \#68751, Bug \#16539903\)  | 
| [Aurora MySQL database engine updates: 2017\-05\-15](AuroraMySQL.Updates.20170515.md) | 1\.13\.0 |  [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Updates.MySQLBugs.html)  | 
| [Aurora MySQL database engine updates: 2017\-04\-05](AuroraMySQL.Updates.20170405.md) | 1\.12\.0 |  [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Updates.MySQLBugs.html)  | 
| [Aurora MySQL database engine updates: 2017\-02\-23](AuroraMySQL.Updates.20170223.md) | 1\.11\.0 |  [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Updates.MySQLBugs.html)  | 
| [Aurora MySQL database engine updates: 2016\-12\-14](AuroraMySQL.Updates.20161214.md) | 1\.10\.0 |  [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Updates.MySQLBugs.html)  | 
