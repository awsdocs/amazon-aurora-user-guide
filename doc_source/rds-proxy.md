...
### RDS Proxy Security<a name="rds-proxy-security"></a>
 ...
 RDS Proxy uses the existing RDS security mechanisms such as Transport Layer Security/Secure Sockets Layer \(TLS/SSL\) and AWS Identity and Access Management \(IAM\)\. For general information about those security features, see [Security in Amazon Aurora](UsingWithRDS.md)\. If you aren't familiar with how RDS and Aurora work with authentication, authorization, and other areas of security, consult those resources first\. 
...
| --- | --- | 
|   `403: The security token included in the request is invalid`   |  [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/rds-proxy.html)  | 
...
|   `ERROR 2005 (HY000): Unknown MySQL server host 'proxy_endpoint' (0)`   |   The proxy endpoint doesn't exist\. This error typically occurs immediately\. Some possible reasons include the following:  [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/rds-proxy.html)  | 
