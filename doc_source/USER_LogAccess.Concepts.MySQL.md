...
For more information about viewing, downloading, and watching file\-based database logs, see [Accessing Amazon Aurora database log files](USER_LogAccess.md)\.
