...
The `oracle_fdw` extension is supported on [PostgreSQL 12\.7, Amazon Aurora PostgreSQL release 4\.2](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraPostgreSQLReleaseNotes/AuroraPostgreSQL.Updates.html#AuroraPostgreSQL.Updates.20180305.42) and higher versions\. 
