...
![\[Select a digest plan\]](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/perf_insights_select_digest_plan.png)

1. Choose **Execution plans \(at digest level\)**\.

   The list shows all plans for this digest statement and their related SQL IDs\.  
![\[List all plans for a digest statement\]](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/perf_insights_digest_plans.png)

1. In Top SQL, select a statement with literal values\.  
![\[Select a query with literal values (not a digest query)\]](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/perf-insights-select-query-literals.png)

   The SQL Information section shows the SQL details\.  
![\[Examine the SQL information section\]](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/perf-insights-sql-details.png)
...
![\[Choose Execution plans\]](http://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/perf-insights-sql-info-plans.png)
