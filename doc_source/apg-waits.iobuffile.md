# IO:BufFileRead and IO:BufFileWrite<a name="apg-waits.iobuffile"></a>
...
#### Reserve sufficient memory for the shared buffer pool<a name="apg-waits.iobuffile.actions.tuning-memory.shared-pool"></a>
