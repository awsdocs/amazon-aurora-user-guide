...
**Topics**
+ [I Am Not Authorized to Perform an Action in Aurora](#security_iam_troubleshoot-no-permissions)
+ [I Am Not Authorized to Perform iam:PassRole](#security_iam_troubleshoot-passrole)
+ [I Want to View My Access Keys](#security_iam_troubleshoot-access-keys)
+ [I'm an Administrator and Want to Allow Others to Access Aurora](#security_iam_troubleshoot-admin-delegate)
...
## I Am Not Authorized to Perform an Action in Aurora<a name="security_iam_troubleshoot-no-permissions"></a>
...
## I'm an Administrator and Want to Allow Others to Access Aurora<a name="security_iam_troubleshoot-admin-delegate"></a>
