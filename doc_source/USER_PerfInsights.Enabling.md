...
## Enabling Performance Insights for Aurora MySQL<a name="USER_PerfInsights.EnableMySQL"></a>

For Aurora MySQL, Performance Insights provides more detailed information when the Performance Schema feature of MySQL is enabled\. The Performance Schema is enabled automatically when you create an Aurora MySQL DB instance with Performance Insights enabled\. When you create the DB instance with Performance Insights enabled, the following subset of Performance Schema parameters is set to the specified values automatically:
