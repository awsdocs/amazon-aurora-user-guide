...
1. On the **Connection** tab, type the following information from your Aurora PostgreSQL database:
   ...
   + For **Username**, type the user name that you entered when you created the DB cluster\. 
   + For **Password**, type the password that you entered when you created the DB cluster\. 
