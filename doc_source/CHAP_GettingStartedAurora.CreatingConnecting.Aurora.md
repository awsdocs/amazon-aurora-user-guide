# Creating and connecting to an Aurora MySQL DB cluster<a name="CHAP_GettingStartedAurora.CreatingConnecting.Aurora"></a>
...
## Step 1: Create an EC2 instance<a name="CHAP_GettingStarted.Creating.AuroraMySQL.EC2"></a>
...
## Step 2: Create an Aurora MySQL DB cluster<a name="CHAP_GettingStarted.Aurora.CreateDBCluster"></a>
...
1. In the **Databases** list, choose the name of the new Aurora MySQL DB cluster to show its details\.
...
## Step 3: Connect to an Aurora MySQL DB cluster<a name="CHAP_GettingStartedAurora.Aurora.Connect"></a>
...
## Step 4: Delete the EC2 instance and DB cluster<a name="CHAP_GettingStartedAurora.Deleting.Aurora"></a>
