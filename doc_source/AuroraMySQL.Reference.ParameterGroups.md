...
|   `aurora_enhanced_binlog`   |   Yes   |   Set the value of this parameter to 1 to turn on the enhanced binlog in Aurora MySQL version 3\.03\.1 and higher\. For more information, see [Setting up enhanced binlog](AuroraMySQL.Replication.MySQL.md#AuroraMySQL.Enhanced.binlog)\.   | 
