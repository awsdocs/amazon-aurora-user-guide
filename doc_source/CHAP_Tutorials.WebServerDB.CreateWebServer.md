...
+ To delete a DB cluster, follow the instructions in [Deleting a DB instance or an Aurora DB cluster](USER_DeleteInstance.md)\. You don't need to create a final snapshot\.
