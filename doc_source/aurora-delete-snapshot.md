# Deleting a DB cluster snapshot<a name="aurora-delete-snapshot"></a>
...
## Deleting a DB cluster snapshot<a name="DeleteDBClusterSnapshot"></a>
...
### Console<a name="aurora-delete-snapshot.CON"></a>
...
### RDS API<a name="aurora-delete-snapshot.API"></a>
