...
| babelfishpg\_tds\.tds\_default\_packet\_size | Integer | 512\-32767 | 4096 | Sets the default packet size for connecting SQL Server clients\. | Yes | 
| babelfishpg\_tds\.default\_numeric\_scale | Integer | 0\-38 | 8 | Sets the default scale of numeric type to be sent in the TDS column metadata if the engine doesn't specify one\. | Yes | 
| babelfishpg\_tds\.default\_numeric\_precision | Integer | 1\-38 | 38 | Sets the default precision of numeric type to be sent in the TDS column metadata if the engine doesn't specify one\. | Yes | 
